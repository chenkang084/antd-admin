...
exports.default = function(args, appBuild, config, paths) {
  ...
  return {
    ...
    plugins: [
      ...
      .concat(analyze ? new _webpackVisualizerPlugin2.default() : [])
      .concat(
...
var _webpackVisualizerPlugin2 = _interopRequireDefault(
  _webpackVisualizerPlugin
);

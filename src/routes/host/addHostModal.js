...
export default function addHostModal() {
    ...
    group_id: {
      ...
      render: () => {
        return (
          ...
          >
            {this.addHostModal.hostGroup.map(group => {
          ...
          <Select
            ...
            filterOption={(input, option) =>
              option.props.children
                ...
                .indexOf(input.toLowerCase()) >= 0}
          >
            {this.addHostModal.hostRacks.map(rack => {
  ...
  return {
    ...
    cluster: this.props.model.defaultCluster,
    ...
    handleModalShow: () => {
      ...
      this.setState({ addHostModalVisible: true });

      // const result = Promise.all(
      //   [
      //     fetchAndNotification({
      //       url: `ceph/clusters/${this.props.modalProps.defaultCluster
      //         .id}/groups/`,
      //       api: "v2"
      //     }),
      //     fetchAndNotification({
    ...
    handleModalHide: () => {
      ...
      this.setState({ addHostModalVisible: false });
    }
  };
}
